					...
					<div class="container main" style="margin-bottom: 170px">
						...
						<div class="center">
							...
							<div id="colp1" class="collapsable">
								...
								<br> <i class="fa fa-hand-o-right mr-2 mt-0-20 pull-left">&nbsp;
									회원 탈퇴</i><br> ㄴ회원정보 수정 페이지에서 회원 탈퇴가 가능합니다.
							</div>
							...
							<div id="colp2" class="collapsable">
								테마별 챌린지 >> 원하는 테마 선택 >> 도전하고 싶은 챌린지 신청! <br> <br> 도전하고
								싶은 챌린지 신청 후<br> 실천 내용 기록과 인증이 가능합니다.
							</div>
							...
							<div id="colp3" class="collapsable">
								로그인 >> 마이페이지 >> 챌린지 현황 >> 보고싶은 챌린지 인증 보러가기 클릭!<br>
								<br> 진행중 챌린지 상세보기 페이지에서<br> 인증 목록/현황 확인과 기록이 가 합니다.
